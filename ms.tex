...
We report the discovery of a young ($\tau \sim \clage$), low-mass ($M \sim 1200~\msun$), metal-poor ($\feh \sim \clfeh$) stellar association in the Milky Way halo.
...
The estimated age of the cluster is consistent with the time of last passage of the leading arm gas through the Galactic midplane, and we therefore speculate that this star-formation event was triggered by the last disk midplane passage at a Galactocentric radius $R \approx 30~\kpc$.
