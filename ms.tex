...
We use a robust linear fit to cross-matched sources (that appear in both PS1 and our observations) to obtain a zero-point and color-term (no color-term was needed for u-band) to calibrate the photometry.
