...
\changes{The photometry was calibrated using Pan-STARRS1 \citep[PS1;][]{Chambers:2016} photometry for g- and i-band and
with SkyMapper \citep{Wolf:2018} for the u-band observations.
We use a robust linear fit to cross-matched sources (that appear in both PS1 and our observations) to obtain a zero-point and color-term (no color-term was needed for u-band) to calibrate the photometry (see \tablename~\ref{tbl:transphot} for the derived transformation coefficients).
...
\tablewidth{400pt}
\tablehead{
\colhead{Band} & \colhead{Color} & \colhead{Zero-point term} & \colhead{Color term} & \colhead{RMS}
}
\startdata
$u$  &  $g-i$ & 2.17820 $\pm$   0.016 &     \nodata  & 0.164 \\
$g$  & $g-r$ & $-0.052868 \pm  0.0068$  &     $-0.034937 \pm 0.0051$  &  0.028 \\
$i$   &  $i-z$ & $-0.246645 \pm 0.0011$ &     $-0.07379 \pm 0.00069$  &  0.028
\enddata
\end{deluxetable}
\end{center}
