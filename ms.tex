...
\newcommand{\clageerr}{\ensuremath{116 \pm 7~\textrm{Myr}}}
\newcommand{\clfeherr}{\ensuremath{-1.14 \pm 0.05}}
\newcommand{\cldisterr}{\ensuremath{28.7 \pm 0.4~\textrm{kpc}}}
\newcommand{\claverr}{\ensuremath{0.21 \pm 0.02}}
...
\changes{The instrumental photometry (i.e., $-2.5\log(\texttm{ADU}~\textrm{sec}^{-1}$) was calibrated using Pan-STARRS1 \citep[PS1;][]{Chambers:2016} photometry for g- and i-band and with SkyMapper \citep{Wolf:2018} for the u-band observations.
We use a robust linear fit to cross-matched sources (that appear in both PS1 and our observations) to obtain a zero-point and color-term (no color-term was needed for u-band) to derive color transformations relating our instrumental DECam photometry to calibrated SkyMapper u- and PS1 grizy photometry (see \tablename~\ref{tbl:transphot} for the derived transformation coefficients).
We apply this color transformation to put our photometry on the SkyMapper/PS1 system, enabling us to treat this photometry as if it were PS1/SkyMapper photometry in the isochrone modeling.
...
The larger scatter in u-band---much larger than the uncertainty in the individual photometry---is due to the large differences in the DECam and SkyMapper u-band passbands.}
...
\tablecaption{DECam Photometric Transformation Equations\label{tbl:transphot}}
\tablecolumns{5}
\tablewidth{400pt}
\tablehead{
...
\startdata
% $u$  &  \nodata & $2.178 \pm  0.016$ &     \nodata \\
% $g$  & $g-r$ & $-0.05287 \pm  0.0068$  &     $-0.03494 \pm 0.0051$ \\
% $i$   &  $i-z$ & $-0.24665 \pm 0.0011$ &     $-0.07379 \pm 0.00069$
$u$  &  \nodata & $27.178 \pm  0.016$ &     \nodata \\
$g$  & $g-r$ & $24.9471 \pm  0.0068$  &     $-0.03494 \pm 0.0051$ \\
$i$   &  $i-z$ & $24.7534 \pm 0.0011$ &     $-0.07379 \pm 0.0007$
\enddata
\end{deluxetable}
\end{center}
...
While no bulk metallicity measurements exist for the LA gas, recent measurements of oxygen and silicon abundances ($\[O/H\] \sim -1$) suggest that the gas has a comparable abundance pattern to the SMC gas \citep{Fox:2018, Richter:2018}.
