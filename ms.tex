...
% - Arrows in Figure 7 and 8 to point out LA II and "low velocity filaments"
% - On Figure 8, show ranges of velocities used in Figure 7
% - Add note to results taht we focus on the larger component of the cluster, but clearly other young stars around, including another small clump. Need more photometric follow-up too!
% - Draw inferred proper motion as a vector on Figure 1, middle panel
...
We therefore use the brightest \emph{kinematic} member of \clustername\ as an ``anchor'' star: \todo{Specify which star this is! Catalog name?}
...
\begin{center}
    \begin{tabular}{ r | l | l}
        ...
        $\mean{\mu_\alpha}$ & $-0.56 \pm TODO~\masyr$ & proper motion in RA\\
        $\mean{\mu_\delta}$ & $0.47 \pm TODO~\masyr$ & proper motion in Dec\\
        \tableline
...
\todo{Somewhere state that this is a slice in Mag. latitude}
}
\label{fig:gasspv}
\end{figure}
