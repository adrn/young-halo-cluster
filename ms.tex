...
\subsection{Measuring the mean proper motion of \clustername}
\label{sec:pmclean}

We infer the mean proper motion of \clustername\ by constructing a probabilistic model of the cluster and background population using astrometric data from \gaia.
...
We then use \texttt{emcee} \citep{Goodman:2010, Foreman-Mackey:2013} to sample from the posterior probability distribution for the hyperparameters given all of the photometric data,
\begin{equation}
...
% TODO: make a table with all inferred parameters!
% - mean sky position
% - inferred proper motion
% - distance
% - age, metallicity, mass
% - extinction
